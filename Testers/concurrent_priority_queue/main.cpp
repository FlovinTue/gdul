...
int main()
{
	...
	gdul::queue_testrun<test_type, gdul::tracking_allocator<test_type>>(
		...
		/*gdul::test_option_single | gdul::test_option_onlyRead | gdul::test_option_onlyWrite  | gdul::test_option_singleReadWrite | gdul::test_option_mpmc gdul::test_option_mpsc |*/ gdul::test_option_spmc);
